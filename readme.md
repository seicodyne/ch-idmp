...
* [Current Stable Version](https://fhir.ch/ig/ch-idmp/index.html)
* [CI Build](https://build.fhir.org/ig/ch-idmp/ch-idmp-fhir/branches/master/index.html)
...
* Then clone the repository via the terminal: `git clone https://github.com/seicodyne/ch-idmp`
* Open the folder of the repository in VSC (File > Open Folder...)
* Navigate to this repository in the therminal (`cd .\ch-idmp\ `)
...
* Option A:
   ...
   * Copy the link from the result in your terminal in a web browser (`file:///C:/Users/username/Documents/GitHub/ch-idmp/qa.html`)
...
* See the output:
   * Validation results (QA): .\ch-idmp\output\qa.html (link is displayed in the command line)
   * Implementation guide: .\ch-idmp\output\index.html (replace qa with index)
