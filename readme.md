...
* Future Version of the ch-idmp project of Refdata [CI Build](https://fhir.refdata.ch)
...
* Then clone the repository via the terminal: `git clone https://github.com/seicodyne/ch-idmp.git`
...
* Option A:
   ...
   * Copy the link from the result in your terminal in a web browser (`file:///C:/Users/username/Documents/GitHub/ch-idmp/output/qa.html`)
