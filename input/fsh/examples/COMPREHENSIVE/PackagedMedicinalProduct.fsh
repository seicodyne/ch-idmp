...
* legalStatusOfSupply[+].code = ChSMCLegalStatusOfSupplyCS#756005034000005 "D: Dispensed following expert advice"
...
* packaging.shelfLifeStorage[0].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000008 "Do not store above 25°C" // Special Precaution for Storage
* packaging.shelfLifeStorage[+].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000004 "protect from light" // Special Precaution for Storage
* packaging.shelfLifeStorage[+].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000011 "Store in the original container" // Special Precaution for Storage
...
* packaging.shelfLifeStorage[=].periodDuration = 6 'mo' "month" // Shelf Life Time Period
 ...
 // Special Precaution for Storage
* packaging.shelfLifeStorage[0].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000006 "at room temperature (15 - 25°C)"
* packaging.shelfLifeStorage[+].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000004 "protect from light" // Special Precaution for Storage
* packaging.shelfLifeStorage[+].specialPrecautionsForStorage.coding = ChSMCSpecialPrecautionsForStorageCS#756005041000011 "Store in the original container" // Special Precaution for Storage
...
// Package Item (Container) - Intermediate Package 2
* packaging.packaging[+].type.coding = $edqm#30054000 "Sachet" // Package Item (Container) Type
* packaging.packaging[=].quantity = 1 // Package Item (Container) Quantity

// Package Item (Container) - Inner Package 2
* packaging.packaging.packaging[+].type.coding = $edqm#15058000 "Tube" // Package Item (Container) Type
* packaging.packaging.packaging[=].quantity = 1 // Package Item (Container) Quantity

* packaging.packaging.packaging[=].containedItem[+].item.reference = Reference(MI-Comprehensive-Sample-VaginalCream)
* packaging.packaging.packaging[=].containedItem[=].amount.value = 10
* packaging.packaging.packaging[=].containedItem[=].amount.unit = "mg"
* packaging.packaging.packaging[=].containedItem[=].amount.system = "http://unitsofmeasure.org"
* packaging.packaging.packaging[=].containedItem[=].amount.code = #mg
