...
* identifier[=].value = "CH-1002233-0682910030000" // MPID
...
* pediatricUseIndicator = ChSMCPediatricUseIndicatorCS#756005003002 "Nicht zugelassen für die Anwendung bei Kindern" // Pediatric Use Indicator
...
* marketingStatus.dateRange.start = "2021-11-09" // Marketing Status Start Date
* marketingStatus.dateRange.end = "2031-11-08" // Marketing Status End Date