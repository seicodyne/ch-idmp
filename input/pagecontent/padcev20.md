...
### Padcev 20 mg 1 Durchstechflasche
The following data example illustrates the composition of the product Padcev 20 mg

#### Indication (in German)
...
{% include img.html img="padcev20.png" caption="Fig. 1: PADCEV 20 mg" width="250 px" %}

#### FHIR Examples
Representation of IDMP data attributes as FHIR XML and JSON:
[FHIR Example](Bundle-a058182b-13dc-4797-9364-2cdb9a4c2bd4.html)
