...
{% include img.html img="xospata40.png" caption="Fig. 5: PADCEV 30 mg" width="350px" %}
...
{% include img.html img="xospata40-structure.png" caption="Fig. 6: XOSPATA 40 mg" width="100%" %}