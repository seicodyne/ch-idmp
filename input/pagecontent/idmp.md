...
### ISO 11615 Document
The base data model for this Swiss ISO-IDMP FHIR IG is based on ISO 11615. The standard can be purchased here: [ISO 11615:2017](https://www.iso.org/standard/70150.html){:target="_blank"}
...
- Published FHIR IG of FOPH/ePL: [https://fhir.ch/ig/ch-idmp/index.html](https://fhir.ch/ig/ch-idmp/index.html){:target="_blank"}
